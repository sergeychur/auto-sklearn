...
def rastrigin(x):
    ...
    return np.sum(x * x - 10 * np.cos(2 * np.pi * x), axis) + 10 * x.shape[axis]

############################
# Data Loading
# ============

X = np.loadtxt('/home/sergey/autosklearn_patch/examples/100_with_doe_repair/data/data.csv', delimiter=',')
y = rastrigin(X)
